...
// Fallback validation middleware without express-rate-limit
// This will work even if express-rate-limit is not installed
...
// Simple rate limits using in-memory storage (development only)
const rateLimits = {
  // Strict limits for authentication
  auth: createSimpleRateLimit(15 * 60 * 1000, 5, 'Too many authentication attempts. Please try again in 15 minutes.'),
  
  // Moderate limits for API calls
  api: createSimpleRateLimit(15 * 60 * 1000, 100, 'Too many API requests. Please try again in 15 minutes.'),
  
  // Lenient limits for general browsing
  general: createSimpleRateLimit(15 * 60 * 1000, 1000, 'Too many requests. Please try again in 15 minutes.'),
  
  // Strict limits for file uploads
  upload: createSimpleRateLimit(60 * 60 * 1000, 10, 'Too many upload attempts. Please try again in 1 hour.')
};
