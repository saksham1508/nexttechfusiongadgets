        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">NextTechFusionGadgets</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/info" className="text-gray-400 hover:text-white">info</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">info@nexttechfusiongadgets.com</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400"> Napier Town, Jabalpur, MP</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 mb-4 md:mb-0">
              © 2025 NextTechFusionGadgets. All rights reserved.
            </p>
