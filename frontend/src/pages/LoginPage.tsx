    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-2">
          ...
          <Link
            to="/vendor/login"
            className="mt-4 inline-flex items-center justify-center px-6 py-2.5 rounded-xl bg-red-600 hover:bg-red-700 text-white font-semibold shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-red-500/50 transition-all"
          >
            Become a Vendor
          </Link>
        </div>
